...
const AdminDashboard = () => {
  ...
  const [activeTab, setActiveTab] = useState('admins'); // New: Track active tab (admins or users)
  const [searchFilter, setSearchFilter] = useState(''); // Unified search filter
  ...
  const [searchFocused, setSearchFocused] = useState(false); // Unified focus state
