...
const FilterForm = ({
  ...
  // Helper: string match (case-insensitive, ignore empty filter)
  ...
  // Helper: number range match (empty min/max means no bound)
  ...
  // Helper: date range match (empty start/end means no bound)
  ...
  // Helper: status match (case-insensitive, ignore empty filter)
  ...
  // Only filter form (for company dashboard)
  if (onlyForm) {
